...
namespace AllPackages {
    ...
    bool Api::PinDc(const std::wstring& domainName, const std::wstring& dcName, ULONG dcFlags) const {
    ...
    bool Api::TransferCred(PLUID sourceLuid, PLUID destinationLuid, ULONG flags) const {
