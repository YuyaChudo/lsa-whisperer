// A copy of ntsecapi.h from the 10.0.26100.0 SDK.
// The header has been modified to have an include
// guard and for some function declerations to be
// commented out. These modifications where done
// to allow ntlsa.h and ntsecapi.h to both be
// included generating C2733 errors caused by
// functions with 'C' linkage being overloaded.
//
#pragma once
